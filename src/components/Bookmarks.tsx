...
export function Bookmarks() {
  ...
  return (
    <div ref={wrapRef} className="relative inline-flex">
      ...
      {open && (
        <div className="fixed inset-x-2 top-[64px] md:absolute md:right-0 md:top-[calc(100%+8px)] z-[70] w-[300px] max-w-[calc(100vw-1rem)] rounded-2xl border border-[var(--glass-border)] bg-[var(--paper-2)] backdrop-blur-xl shadow-[var(--shadow-hover)] p-3 animate-fadeIn origin-top-right">
