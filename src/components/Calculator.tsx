...
export function Calculator() {
  ...
  return (
    <div ref={wrapRef} className="relative inline-flex">
      ...
      {open && (
        <div className="absolute right-0 top-[calc(100%+8px)] z-[70] w-[270px] rounded-2xl border border-[var(--glass-border)] bg-[var(--paper-2)] backdrop-blur-xl shadow-[var(--shadow-hover)] p-3 animate-fadeIn origin-top-right">
