...
export function CommandPalette() {
  ...
  const actions = useMemo<Action[]>(() => {
    ...
    const list: Action[] = [
      ...
      { id: "ledger", label: "Open the Ledger", hint: "Finance", run: () => { emitCommand({ kind: "hub" }); close(); } },
      { id: "ledger-net", label: "Net worth", hint: "Ledger", run: () => { emitCommand({ kind: "hub", value: "networth" }); close(); } },
      { id: "ledger-bills", label: "Bills", hint: "Ledger", run: () => { emitCommand({ kind: "hub", value: "bills" }); close(); } },
      { id: "ledger-apps", label: "Applications", hint: "Ledger", run: () => { emitCommand({ kind: "hub", value: "apps" }); close(); } },
      { id: "ledger-cpa", label: "CPA exam tracker", hint: "Ledger", run: () => { emitCommand({ kind: "hub", value: "cpa" }); close(); } },
