...
export const THEME_BOOT_SCRIPT = `
  (function() {
    try {
      ...
      var ok = ['galaxy','forest','water','rain','sunset','ottoman','stainedglass','deco','cyberpunk','y2k','brutalist','bauhaus','retro','renaissance','marble','subway','terminal','mono','newspaper','blueprint','comic','sakura'];
